...
const Home = () => {
    ...
    return (
        <div className="gap-10">
            ...
            <div className="mt-10 ">
                <p className="text-gray-600 flex justify-center items-center text-center text-xl ">Discover amazing stories, insights, and ideas from our community of <br /> writers.Sign in to create your own posts and save your favorites.</p>
            </div>

            <div className="flex gap-40 flex-wrap pl-40 pr-30 justify-between mt-10 px-5 py-10">

                {
                    posts.map((post) => (

                        <div className="w-96 bg-white shadow-lg rounded-lg h-[45%]" key={post.id}>
                            <div className="relative">
                                ...
                                <button className="p-3 text-sm text-white bg-blue-600 rounded-full absolute cursor-pointer left-4 top-3">Technology</button>
                            </div>
                            <div className="flex gap-5 mt-3 px-2">
                                ...
                                <div className="mt-5">
                                    ...
                                    <p className="text-gray-600">{post.postedOn}{post.timeRead}</p>
                                </div>
                            </div>
                            <div ClassName="mt-5">
                            ...
                            <div className="border-[0.5px] border-gray-400 w-[90%] mt-9"></div>
                            <div className="flex">
                                <p>{post.timeRead}</p>
                                <p>Read more</p>
                                </div>
